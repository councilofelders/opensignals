...
class Provider:
    ...
    def download_tickers(self, tickers, start):
        ...
        with futures.ThreadPoolExecutor() as executor:
            ...
            for ticker in tickers:
                _futures.append(
                    executor.submit(self.download_ticker, ticker=ticker, start_epoch=start_epoch, end_epoch=end_epoch)
                )
    ...
    def download_data(self, db_dir, recreate=False):
        if recreate:
